...
public class TeacherEditQuest implements HttpHandler {
    private AllDAOs allDAOs;
    private CookieHelper cookieHelper;

    public TeacherEditQuest(AllDAOs allDAOs, CookieHelper cookieHelper){
...
//            }
    ...
    private void createResponse(HttpExchange httpExchange) throws IOException{
        JtwigTemplate template = JtwigTemplate.classpathTemplate("template/teacher/editQuest.twig");
